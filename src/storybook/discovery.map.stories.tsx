...
NoData.args = {
  ...InitialUsage.args,
  ws: `NEWGTS 'g' STORE
1 6 <% 'ts' STORE $g $ts NaN NaN NaN RAND ADDVALUE DROP %> FOR
$g`,
  options: {...Usage.options}
}
